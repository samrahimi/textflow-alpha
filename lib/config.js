module.exports = {
    ...
    credentials: {
        watson_tone: {
            ...
            "password": process.env.WATSON_PASSWORD || "luBU7QYYbcOv",
            "username": process.env.WATSON_USER || "2441e90e-0bf9-4ab8-83c7-60dfe0f03218"
        },
        google_sentiment: {
            "url": "https://language.googleapis.com/v1/documents:analyzeSentiment?key=AIzaSyDI41d-qsNwV9c7OWwOg5ShYIfx0pOf0eA",
        },
        mongodb: process.env.DB || 'mongodb://dumb:bitch@ds131729.mlab.com:31729/textflow'
    },
    user: {
