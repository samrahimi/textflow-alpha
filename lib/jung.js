var rules = require('../data/rules/jung.json')
...
module.exports = {
    analyze: function(message, raw_scores, context, callback) {
        ...
        //context must contain a field called ruleset_id
        results.aggregate_score=getAggregateScore(raw_scores, context.id)
        results.advice = getOverallAdvice(raw_scores, results.aggregate_score, context.id)
